    ...
    <div className="font-[family-name:var(--font-aktiv-grotesk)]">
      ...
      <section className="relative min-h-screen flex items-center justify-center">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          <div className="flex flex-col gap-[22px] items-center sm:items-start">
            <div className="text-center sm:text-left">
              <h1 className="text-4xl sm:text-7xl font-medium tracking-tight mb-4 text-white">
              ...
              <Button
                asChild
                variant="secondary"
                className="mt-8 gap-2 rounded-none"
              >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <h2 className="text-4xl sm:text-5xl font-medium tracking-tight text-[#2F473A] mb-8">
      ...
      {/* Technology Section */}
      <section id="technology" className="relative bg-gray-100 py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            {/* Left side - Technology description */}
            <div>
              <h2 className="text-3xl sm:text-4xl font-mono text-[#2F473A] mb-4">
          ...
          <div className="mt-10">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {/* High-Res Sensing */}
              <div 
                className={`backdrop-blur-sm p-4 transition-colors cursor-pointer ${
                  activeTech === 'sensing' 
              ...
              >
                <div className="text-center">
                  <h3 className="text-lg font-medium text-white mb-2">High-Res Sensing</h3>
                </div>
              </div>
              ...
              >
                <div className="text-center">
                  <h3 className="text-lg font-medium text-white mb-2">Real-Time Insights</h3>
                </div>
              </div>
              ...
              >
                <div className="text-center">
                  <h3 className="text-lg font-medium text-white mb-2">Actionable Intelligence</h3>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            <div className="text-left">
              <h2 className="text-3xl sm:text-3xl font-medium tracking-tight text-[#2F473A] mb-6">
                About Us
              </h2>
              <p className="text-lg text-gray-800">
                Verdus Labs is a three-person company based in Ithaca, New York.<br />
            ...
            <div className="flex justify-end">
              <div className="grid grid-cols-3 gap-4 w-fit">
                {teamMembers.map((member, index) => (
                  <div key={index} className="group relative overflow-hidden aspect-square w-24 h-24 md:w-32 md:h-32">
                    <div className="relative w-full h-full bg-gray-200 flex items-center justify-center">
                      {member.image ? (
                        ...
                        <div className="text-center text-gray-400">
                          <div className="w-8 h-8 mx-auto mb-1 bg-gray-300 flex items-center justify-center">
                    ...
                    <div className="absolute inset-0 bg-[#2F473A]/90 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
                      <div className="text-center text-white p-2">
                        <h3 className="text-xs font-medium mb-1">{member.name}</h3>
      ...
      {/* Footer */}
      <footer className="bg-white border-t border-gray-200 py-8 font-[family-name:var(--font-aktiv-grotesk)]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
